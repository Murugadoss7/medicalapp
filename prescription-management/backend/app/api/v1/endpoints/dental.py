...
# NOTE: File attachment endpoints have been moved to dental_attachments.py
# See: app/api/v1/endpoints/dental_attachments.py
# - POST   /observations/{observation_id}/attachments  - Upload observation attachment
# - POST   /procedures/{procedure_id}/attachments      - Upload procedure attachment
# - GET    /observations/{observation_id}/attachments  - Get observation attachments
# - GET    /procedures/{procedure_id}/attachments      - Get procedure attachments
# - GET    /patients/{mobile}/{first_name}/attachments - Get patient attachments
# - PUT    /attachments/{attachment_id}                - Update attachment metadata
